...
public class AIService {
    ...
    public Double predictNextMonth(Long companyId) {
        ...
        List<DayPrice> data = dayPriceRepository.findByCompanyIdAndDateBetween(companyId, LocalDate.now().minusMonths(1), LocalDate.now());;
    ...
    public static List<Map<String, Object>> mapToRequestData(List<DayPrice> historicalDataEntities) {
